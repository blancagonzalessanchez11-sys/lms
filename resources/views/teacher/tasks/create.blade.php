...
<div class="container mx-auto px-4 py-6">  {{-- Padding reducido para alta densidad --}}
    ...
    <div class="bg-white rounded-lg shadow-md p-4">  {{-- Padding reducido --}}
        ...
        <form action="{{ route('teacher.tasks.store') }}" method="POST" class="row g-3">  {{-- Grid con gap reducido --}}
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    <label for="title" class="form-label small fw-bold">Título de la Tarea</label>  {{-- Label pequeño --}}
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control form-control-sm" id="start_date" name="start_date" value="{{ old('start_date', now()->toDateString()) }}">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="8" placeholder="Describe las instrucciones detalladas de la tarea...">{{ old('description') }}</textarea>  {{-- Área grande --}}
